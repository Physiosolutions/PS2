...
(function () {
    ...
    const MERGE_HANDLERS = {
        ...
        leave_records: function (rows, mode) {
            ...
            if (typeof synchronizeWorkspaceCoreStatus === 'function') synchronizeWorkspaceCoreStatus();
            if (typeof populateWdFilters === 'function' && typeof renderWorkingDaysDashboard === 'function') {
                const wdTab = document.getElementById('ls_tab_workingdays');
...
// Execute the import and combine operation
    window.IMPORTER_HANDLERS = MERGE_HANDLERS;
